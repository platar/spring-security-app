package info.lavait.springsecurityapp.security;

import info.lavait.springsecurityapp.auth.ApplicationUserService;
...
//                .and()
//                .rememberMe().key("uniqueAndSecret"); // default to 2 weeks
    }
